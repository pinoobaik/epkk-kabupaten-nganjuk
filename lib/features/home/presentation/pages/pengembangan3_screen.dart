...
class Pengembangan3 extends StatefulWidget {
  const Pengembangan3({super.key});

  @override
  State<Pengembangan3> createState() => _Pengembangan3ScreenState();
}

class _Pengembangan3ScreenState extends State<Pengembangan3> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection('Pemula', [
                _buildDetailItem('Jumlah kelompok', data['jumlah_kelompok_pemula'] ?? '0'),
          ...
          child: Obx(
            () => ButtonFill(
              ...
              onPressed: uploadController.isLoading.value
                  ...
                  : () async {
                    try {
                      await uploadController.submitPengembanganKehidupan(
                        idUser: data['id_user'] , 
                        jumlahKelompokPemula: data['jumlah_kelompok_pemula'] , 
                        jumlahPesertaPemula: data['jumlah_peserta_pemula'] , 
                        jumlahKelompokMadya: data['jumlah_kelompok_madya'] , 
                        jumlahPesertaMadya: data['jumlah_peserta_madya'] , 
                        jumlahKelompokUtama: data['jumlah_kelompok_utama'] , 
                        jumlahPesertaUtama: data['jumlah_peserta_utama'] , 
                        jumlahKelompokMandiri: data['jumlah_kelompok_mandiri'] , 
                        jumlahPesertaMandiri: data['jumlah_peserta_mandiri'] , 
                        jumlahKelompokHukum: data['jumlah_kelompok_hukum'] , 
                        jumlahPesertaHukum: data['jumlah_peserta_hukum'] , 
                        idRole: data['id_role'] , 
