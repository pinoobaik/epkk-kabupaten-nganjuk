        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection('Makanan Pokok', [
                _buildDetailItem('Beras', data['beras'] ?? '0'),
                _buildDetailItem('Non Beras', data['non_beras'] ?? '0'),
              ]),

              // Paket Madya Section
              _buildSection('Pemanfaatan Pekarangan/ Hatinya PKK', [
                _buildDetailItem('Peternakan', data['peternakan'] ?? '0'),
                _buildDetailItem('Perikanan', data['perikanan'] ?? '0'),
                _buildDetailItem('Warung Hidup', data['warung_hidup'] ?? '0'),
                _buildDetailItem('Lumbung Hidup', data['lumbung_hidup'] ?? '0'),
                _buildDetailItem('TOGA', data['toga'] ?? '0'),
                _buildDetailItem('Tanaman Keras', data['tanaman_keras'] ?? '0'),
              ]),
